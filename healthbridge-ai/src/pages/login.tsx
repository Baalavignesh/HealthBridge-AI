  ...
  return (
    ...
    <div className="flex items-center justify-center h-screen bg-gray-100" style={{
      ...
      <div className="bg-white p-8 rounded shadow-md w-96">
        ...
        <p className="text-center mb-4">{userType} Portal</p>
        <hr></hr>
        ...
        <div className="mt-4 text-center">
          <p className="cursor-pointer bg-blue-500 text-white p-2 rounded hover:bg-blue-600" onClick={() => {
            setUserType(userType === "Doctor" ? "Patient" : "Doctor")
            localStorage.setItem("usertype", userType === "Doctor" ? "Patient" : "Doctor")
          }}>
            Take me to {userType === "Doctor" ? "Patient" : "Doctor"} Portal
          </p>
        </div>
      </div>
    </div>
